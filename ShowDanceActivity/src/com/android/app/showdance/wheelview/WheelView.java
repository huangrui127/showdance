...
//	private static final int[] SHADOWS_COLORS = new int[] { 0xFF111111, 0x00AAAAAA, 0x00AAAAAA };
	private static final int[] SHADOWS_COLORS = new int[] {0xFFf8f9fa, 0xb9f8f9fa, 0xb9f8f9fa};
	...
	private void initResourcesIfNecessary() {
		...
		if (centerDrawable == null) {
			centerDrawable = getContext().getResources().getDrawable(R.drawable.wheel_val1);
		}
