...
public class FoundRamdomAdapter extends BaseAdapter {
	...
	public FoundRamdomAdapter(Context context, List<Map<String, Object>> menulist) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = listInflater.inflate(R.layout.found_ramdom_item, null);
