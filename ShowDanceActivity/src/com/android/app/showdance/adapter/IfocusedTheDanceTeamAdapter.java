...
public class IfocusedTheDanceTeamAdapter extends BaseAdapter {
	...
	public IfocusedTheDanceTeamAdapter(Context context, List<Map<String, Object>> menulist) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = listInflater.inflate(R.layout.activity_i_focused_the_dance_team_item, null);
