...
public class DownloadRecommendAdapter extends DownloadAdapter<DownloadMusicInfo> implements ContentValue {
    ...
    public DownloadRecommendAdapter(Context mContext, List<DownloadMusicInfo> downloadInfoList,
            String filePathForSDCard, String recordedAction, String downloadAction) {
     ...
     */
    @Override
    protected void downloadFileSelect(DownloadMusicInfo dmi, ViewHolder holder) {
