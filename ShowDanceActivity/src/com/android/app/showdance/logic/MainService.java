	...
	private void doTask(Task mTask) {
		...
		if (NetUtil.isNetworkConnected(this)) {
			...
			case TaskType.TS_danceMusicPageList: // 43 下载推荐舞曲
				...
				List<DownloadMusicInfo> resultDanceMusicPageVo = SoapWebServiceInterface.danceMusicPageVoToJson(danceMusicPageVo);
			...
			case TaskType.TS_GETMYVIDIO:// 101 查询我的视频 (即我的秀舞)
				...
				ArrayList<Map<String, Object>> mediaInfoPageVoMap2 = SoapWebServiceInterface.MediaInfoPageVoToJson(mediaInfoPageVo);
			...
			case TaskType.TS_DELETEMEDIAINFO:// 100 删除我的视频 (即我的秀舞)
				...
				Map<String, Object> resultDeleteMediaInfo = SoapWebServiceInterface.deleteMediaInfoToJson(deleteMediaInfo);
			...
			case TaskType.TS_MYATTENTION: // 102 我关注的
				...
				ArrayList<Map<String, Object>> userFansPageVoMap2 = SoapWebServiceInterface.myAttentionPageVoToJson(mUserFansPageVo2);
			...
			case TaskType.TS_MYFANS:// 103 我的粉丝
				...
				ArrayList<Map<String, Object>> userFansPageVoMap = SoapWebServiceInterface.UserFansPageVoToJson(mUserFansPageVo);
				message.obj = userFansPageVoMap;
				break;

			case TaskType.TS_MYDOWNLOADMV:// 104 我的下载（我下载的视频）
				DownloadMediaPageVo downloadMediaPageVo = (DownloadMediaPageVo) mTask.getTaskParam().get("downloadMediaPageVo");
				ArrayList<Map<String, Object>> downloadMediaPageVoMap = SoapWebServiceInterface.downloadMediaPageVoToJson(downloadMediaPageVo);
			...
			case TaskType.TS_GETMEDIAINFO:// 106
				...
				Map<String, Object> mediaInfoPageVoData2 = SoapWebServiceInterface.getMediaInfoByIdToJson(mediaInfoPageVo2);
				message.obj = mediaInfoPageVoData2;
				break;
			case TaskType.TS_GETUSERMEDIAMUSICCOUNT:// 107
													// 根据用户id，获取关注舞友、粉丝、下载视频、我的秀舞
													// 数量
				VUserFansMediaMusicCount vUserFansMediaMusicCount = (VUserFansMediaMusicCount) mTask.getTaskParam().get("vUserFansMediaMusicCount");
				Map<String, Object> vUserFansMediaMusicCountData = SoapWebServiceInterface.getVUserFansMediaMusicCountByIdToJson(vUserFansMediaMusicCount);
			...
			case TaskType.TS_GETMEDIACOMMENTLIST:// 113 获取视频评论
				MediaCommentPageVo mediaCommentPageVo = (MediaCommentPageVo) mTask.getTaskParam().get("mediaCommentPageVo");
				ArrayList<Map<String, Object>> mediaCommentPageVoData = SoapWebServiceInterface.getMediaCommentListByMediaIdToJson(mediaCommentPageVo);
			...
			case TaskType.TS_MediaInfoList:// 301 首页 视频榜单
				...
				ArrayList<Map<String, Object>> resultMediaInfoPageVoList = SoapWebServiceInterface.mediaInfoPageVoListToJson(mediaInfoPageVoList);
			...
			case TaskType.TS_MediaInfoPageList:// 304 已录制视频
				...
				ArrayList<Map<String, Object>> resultMediaInfoPageList = SoapWebServiceInterface.mediaInfoPageListToJson(mediaInfoPageList);
				message.obj = resultMediaInfoPageList;
				break;
			case TaskType.TS_MusicInfoPageList:// 305 已下载舞曲
				DownloadMusicPageVo downloadMusicPageVoList = (DownloadMusicPageVo) mTask.getTaskParam().get("downloadMusicPageVo");
				int refreshTypeMusic = (Integer) mTask.getTaskParam().get("refreshType");
				ArrayList<Map<String, Object>> resultDownloadMusicPage = SoapWebServiceInterface.downloadMusicPageListToJson(downloadMusicPageVoList);
			...
			case TaskType.TS_SaveDownloadMusic:// 307 保存已下载舞曲记录
				...
				Map<String, Object> resultDownloadMusic = SoapWebServiceInterface.saveDownloadMusicToJson(downloadMusic);
			...
			case TaskType.TS_getVDanceMusicDancerList:// 获取明星老师列表
				...
				List<TeacherDancerMusic> resultGetVDanceMusicDancerList = SoapWebServiceInterface.dancerListToJson(dancerList);
			...
			case TaskType.TS_SaveMediaInfo:// 306 上传视频信息
				...
				Map<String, Object> resultMediaInfo = SoapWebServiceInterface.saveMediaInfoToJson(mediaInfo, requestCode);
...
//				curActivity = AppManager.getAppManager().getActivityByName(HomePageActivity.class);
				paramCount = 3;
				break;
			...
			case TaskType.TS_DELETEMEDIAINFO:// 101 删除我的秀舞
				curActivity = AppManager.getAppManager().getActivityByName(ListToDanceVideoActivity.class);
				break;

			case TaskType.TS_GETMYVIDIO:// 101 我的秀舞
				switch (msg.arg1) {
				case ConstantsUtil.videoType1:
					curActivity = AppManager.getAppManager().getActivityByName(ListToDanceVideoActivity.class);
					break;
				case ConstantsUtil.videoType2:
					curActivity = AppManager.getAppManager().getActivityByName(FoundNearManDetail.class);
					break;
				case ConstantsUtil.videoType3:
					curActivity = AppManager.getAppManager().getActivityByName(VideoDetailsActivity.class);
					break;
			...
			case TaskType.TS_MYATTENTION:// 102 我关注的
				curActivity = AppManager.getAppManager().getActivityByName(TheDanceMemberActivity.class);
				break;
			case TaskType.TS_MYFANS:// 103 我的粉丝
				curActivity = AppManager.getAppManager().getActivityByName(TheDanceMemberActivity.class);
				break;
			// add by pyy
			case TaskType.TS_MYDOWNLOADMV:// 104 我的下载
				curActivity = AppManager.getAppManager().getActivityByName(ListToDanceVideoActivity.class);
				break;
			case TaskType.TS_GETNEARMANDETAIL:// 105 根据用户id，查询用户详情
				curActivity = AppManager.getAppManager().getActivityByName(FoundNearManDetail.class);
