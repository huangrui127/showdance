...
public class FoundNearDanceTeamActivity extends BaseActivity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_found_near_dance_team);
		findViewById();
		initView();
		setOnClickListener();
		...
		found_near_dance_team_lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
				...
				intent.setClass(FoundNearDanceTeamActivity.this, FoundNearDanceTeamDetail.class);
	...
	protected void initView() {
		...
		// 创建适配器对象
		FoundNearDanceTeamAdapter foundNearDanceTeamAdapter = new FoundNearDanceTeamAdapter(FoundNearDanceTeamActivity.this,listItem);
		found_near_dance_team_lv.setAdapter(foundNearDanceTeamAdapter);// 为ListView绑定适配器
