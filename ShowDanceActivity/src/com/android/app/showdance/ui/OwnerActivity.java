...
public class OwnerActivity extends VolleyBaseActivity {
    ...
    public void onEventMainThread(UploadDeleteEvent event) {
        ...
        CustomAlertDialog mCustomDialog = new CustomAlertDialog(OwnerActivity.this)
        ...
        VolleyManager.getInstance().postRequest(request,
                ...
                new OnResponseListener<VideoUploadInfo.ShowResponse>(VideoUploadInfo.ShowResponse.class) {
                    ...
                    protected void handleResponse(ShowResponse response) {
                        ...
                        if (mAdapter == null) {
                            mAdapter = new UploadedVideoAdapter(OwnerActivity.this, mVideoUploadList);
    ...
    protected void initView() {
        ...
        if (!TextUtils.isEmpty(stage_name)) {
            ...
            // Toast.makeText(getApplicationContext(), "请优先完善个人信息!",
    ...
    private SwipeListViewListener swipeListViewListener = new SwipeListViewListener() {
        ...
        public void onClickFrontView(int position) {
            ...
            Log.d(TAG, "打开的网页是----【"+mVideoUploadList.get(position).getvideoname()+"】");
    ...
    public void onClick(View v) {
        ...
        // setShareContent();
        //
        // uMController.getConfig().setPlatforms(SHARE_MEDIA.WEIXIN,
        // SHARE_MEDIA.WEIXIN_CIRCLE, SHARE_MEDIA.SINA, SHARE_MEDIA.TENCENT);
        //
        ...
        //
        // } else {
        // Toast.makeText(getApplicationContext(), "请先登录后分享视频!",
        // Toast.LENGTH_SHORT).show();
        // }
