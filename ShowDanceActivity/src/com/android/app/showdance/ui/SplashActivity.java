...
public class SplashActivity extends Activity {
    ...
    private void goHome() {
        ...
        // ShowDanceActivity.class);
        Intent intent = new Intent(SplashActivity.this, ShowDanceMainActivity.class);
    ...
    public static class UrlRespone {
        ...
        public void setactiveNote(String noteUrl) {
            this.activeNote = noteUrl;
        }
    ...
    private void showUpdateApkDialog(final String uri, String content) throws UnsupportedEncodingException {
        ...
        }).setNegativeButton(getResources().getString(R.string.settings_logout), new OnClickListener() {
            @Override
            public void onClick(View v) {
                // goHome();
                finish(); // 强制升级，如果不升级，则直接退出APP
            }
        }).show();
    }
        ...
        StringRequest request = new StringRequest(Method.GET, "http://www.xiuwuba.net:8086/androiod.json",
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            helpUrl = objectMapper.readValue(json.substring(json.indexOf("{")), UrlRespone.class);
