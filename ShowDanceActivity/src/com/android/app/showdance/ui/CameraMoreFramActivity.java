...
//				MainService.newTask(mTask);
		...
		VolleyManager.getInstance().postRequest(
				request,
				VolleyManager.METHOD_DOWNLOAD_FRAME,
				mMusicResponseListener, mErrorListener);
	}
	private OnResponseListener<FrameInfo.Response> mMusicResponseListener = new OnResponseListener<FrameInfo.Response>(FrameInfo.Response.class) {
		@Override
		public void handleResponse(FrameInfo.Response response) {
			...
			if(showDanceRecommendAdapter ==null) {
				showDanceRecommendAdapter = new FrameInfoListAdapter(CameraMoreFramActivity.this, recommendFrameList, InitApplication.sdCardForegroundPath);
