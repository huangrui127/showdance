...
public class DownloadedMusicActivity extends BaseActivity implements OnItemClickListener {
    ...
    public void onClick(View v) {
        ...
        case R.id.return_imgbtn:// 返回
            this.finish();
            sendBroadcast(new Intent(ConstantsUtil.ACTION_DOWNLOADED_MUSIC_ACTIVITY));
            break;
        }
    ...
    private class ScanVideoTask extends AsyncTask<Void, File, List<Map<String, Object>>> {
        ...
        protected void onPostExecute(List<Map<String, Object>> result) {
            ...
            if (mDownloadedMusicList != null && mDownloadedMusicList.size() != 0) {
                ...
                no_login_layout.setVisibility(View.GONE);
                mDownloadedMusicAdapter = new DownloadedMusicAdapter(DownloadedMusicActivity.this,
                        mDownloadedMusicList);
    ...
    protected void handleReceiver(Context context, Intent intent) {
        ...
        if (intent.getAction().equals(ConstantsUtil.ACTION_DOWN_MEDIARECORDER)) {
            ...
            CameraPreviewActivity.actionRecord(this, REQUEST_RECORD, musicItem.get("path").toString(),
                    musicItem.get("name").toString());
            // } else {
    ...
    private void handleRecordVideoResult(final String videopath) {
        ...
        if (jointOutFile.exists() && jointOutFile.length() > 0) {
            ...
            CustomAlertDialog mCustomDialog = new CustomAlertDialog(DownloadedMusicActivity.this)
            ...
            mCustomDialog.setPositiveButton(getResources().getString(R.string.dialog_ok), new OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    // mIntent.setClass(DownloadedMusicActivity.this,
                    // VideoViewPlayingActivity.class);
                    // mIntent.setData(Uri.parse(videopath));
                    // startActivity(mIntent);

                    Intent intent = new Intent(DownloadedMusicActivity.this, PlayVideoActivity.class);
    ...
    public void onItemClick(AdapterView<?> arg0, View arg1, final int position, long arg3) {
        ...
        mCustomDialog.setPositiveButton(getResources().getString(R.string.dialog_ok), new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                delFilePath.delete();
                if (position >= mDownloadedMusicList.size())
                    return;
