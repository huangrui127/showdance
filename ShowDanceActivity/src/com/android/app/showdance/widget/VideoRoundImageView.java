 ...
 * @author Alan
 */
public class VideoRoundImageView extends ImageView {
	...
	public void setBitmapPath(final String bitmappath) {
		post(new Runnable() {
			@Override
			public void run() {
				Bitmap bg = com.umeng.socialize.utils.BitmapUtils.getBitmapFromFile(bitmappath);
				bg = Bitmap.createScaledBitmap(bg, 160, 90, true);
				setBackground(new BitmapDrawable(mContext.getResources(),bg));
			}
		});
	}
