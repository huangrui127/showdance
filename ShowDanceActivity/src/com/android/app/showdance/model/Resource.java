...
/**
 * 受保护的资源菜案Resource. Author 尔演&Eryan eryanwcp@gmail.com Date 2013-3-21
 * 上午12:27:49
 * 
 */
...
// "handler","fieldHandler" , "parentResource",
...
public class Resource extends BaseEntity implements Serializable {
	...
	// FetchType.LAZY)
	// @JoinTable(name = "T_SYS_ROLE_RESOURCE", joinColumns = {@JoinColumn(name
	// = "RESOURCE_ID")},
...
//	}
	...
	// @ManyToMany(cascade = {CascadeType.PERSIST, CascadeType.MERGE}, fetch =
	// FetchType.LAZY)
	// @JoinTable(name = "T_SYS_USER_RESOURCE", joinColumns = {@JoinColumn(name
	// = "RESOURCE_ID")},
