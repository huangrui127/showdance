...
public class MusicInfo {
    ...
    public static class MusicSearchResponse implements Serializable {
        ...
        public String toString() {
            return "created_at " + created_at + "download_volume " + download_volume + " id " + id + " url " + url
                    + " name " + name + " size  " + size + " singer " + singer + " sort " + sort + " teacher " + teacher
                    + "updated at  " + updated_at + " teacher " + teacher;
        }
    }
}
