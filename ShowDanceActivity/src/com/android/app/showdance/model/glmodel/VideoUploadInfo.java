...
public class VideoUploadInfo {
    ...
    public static class Request {
        ...
        private String x; // 所在经度
        private String y; // 所在纬度
        private String theme; // 参加的主题活动名

        public Request() {

        }

        public Request(String name, int user_id, String video_name, String path, String province, String city, String x,
                String y, String theme) {
            super();
            this.name = name;
    ...
    public static class VideoUploadResponse implements Serializable {

        private static final long serialVersionUID = 2618965911541703476L;
