...
public class ShowDanceActivity extends VolleyBaseActivity {
    ...
    private void updateUserInfo() {
        ...
        request.setstring(
                getAppVersionName(ShowDanceActivity.this) + ";product:" + Build.PRODUCT + ";phone:" + user.getPhone());
        request.settype(10);
    ...
    protected void findViewById() {
        ...
        btn_tearch = (Button) findViewById(R.id.id_btn_teacher);
        btn_rhythm = (Button) findViewById(R.id.id_btn_rhythm);
        btn_edit = (Button) findViewById(R.id.id_btn_edit);

        serach_layout = (LinearLayout) findViewById(R.id.search_layout);
    ...
    private OnResponseListener<MusicInfo.Response> mMusicResponseListener = new OnResponseListener<MusicInfo.Response>(
        ...
        public void handleResponse(MusicInfo.Response response) {
            ...
            if (showDanceRecommendAdapter == null) {
                showDanceRecommendAdapter = new DownloadRecommendAdapter(ShowDanceActivity.this, recommendMusicList,
                        InitApplication.SdCardMusicPath, ConstantsUtil.ACTION_SHOW_MEDIARECORDER,
    ...
    public void onClick(View v) {
        ...
        case R.id.login_btn: // 登录
            ...
            break;
        case R.id.id_btn_teacher: // 明星老师
            mIntent.setClass(this, TeacherActivity.class);
            startActivity(mIntent);
            break;

        case R.id.id_btn_rhythm: // 节奏

            break;

        case R.id.id_btn_edit: // 制作
    ...
    public void onEventMainThread(MusicEvent event) {
        ...
        Log.d("guolei", "musicId " + musicId + " info pos =   " + position + " state " + state);
        switch (state) {
