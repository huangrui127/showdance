...
public class InitApplication extends Application {
    ...
    public void onCreate() {
        ...
        sdCardAvator2ForegroundPath = ConstantsUtil.RootDirectory.getAbsolutePath()
                + ConstantsUtil.sdCardAvator2ForegroundPath;
        ...
        sdCardAvator3ForegroundPath = ConstantsUtil.RootDirectory.getAbsolutePath()
                + ConstantsUtil.sdCardAvator3ForegroundPath;
    ...
    // }
    // Log.i("BaiduLocationApiDem", mLocation.getLatitude() + "----" +
    ...
    // + File.separator + "com.android.app.wumeiniang" + File.separator +
    // CityDB.CITY_DB_NAME;
