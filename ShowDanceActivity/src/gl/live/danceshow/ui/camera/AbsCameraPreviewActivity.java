...
public abstract class AbsCameraPreviewActivity extends FragmentActivity implements OnFgItemClickListener, AutoFocusCallback {
    protected static final String TAG = "AbsCameraPreviewActivity";
    
    protected CenteredPreview mPreview;
    protected MediaEngine mMediaEngine;
    protected ImageView mFg;
//    protected SimpleDraweeView mFgSdv; // 相机遮罩效果图
...
//        mFgSdv = new SimpleDraweeView(this);
//        mFgSdv.setScaleType(ScaleType.FIT_XY);
//        mFgSdv.setLayoutParams(p);
...
//				    mFgSdv.setBackground(mPreDrawable);
					mPreDrawable.start();
				}
			});
            } else {
