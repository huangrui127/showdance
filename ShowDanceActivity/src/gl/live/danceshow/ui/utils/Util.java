...
//    }
    ...
    private static void saveLyric(ArrayList<String> lrcList, String title,
        ...
        try {
            ...
            File dir = new File(InitApplication.SdCardLrcPath, "Lyrics"
                    + File.separator);
            dir.mkdirs();
    ...
    public static Size getExpectedSize() {
    	 Size mSize;
...
//            br.close();
//            int ram = Integer.parseInt(subMemoryLine.replaceAll("\\D+", "")) /1024;
//            if(ram <1224) {
//            	mSize = new Size(320, 180);
//            } else
//            mSize = new Size(320, 180);
