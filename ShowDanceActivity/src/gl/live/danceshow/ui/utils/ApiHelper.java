...
public class ApiHelper {
    ...
    public static int getIntFieldIfExists(@NonNull Class<?> klass, String fieldName,
    ...
    private static boolean hasField(@NonNull Class<?> klass, String fieldName) {
        try {
    ...
    private static boolean hasMethod(
            @NonNull Class<?> klass, String methodName, Class<?> ... paramTypes) {
        try {
