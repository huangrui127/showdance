package gl.live.danceshow.ui.camcorder;
...
import static gl.live.danceshow.ui.camcorder.CameraManager.Assert;
...
public class CameraHolder {
    ...
    private static synchronized void collectState(int id, @Nullable CameraManager.CameraProxy device) {
    ...
    public static void injectMockCamera(CameraInfo[] info, CameraManager.CameraProxy[] camera) {
    ...
    @Nullable
    public synchronized CameraManager.CameraProxy open(int cameraId)
