...
import gl.live.danceshow.ui.utils.ApiHelper;
...
public class CameraManager {
    ...
    private class CameraHandler extends Handler {
        CameraHandler(@NonNull Looper looper) {
            super(looper);
        }
    ...
    private void setAutoFocusMoveCallback(@NonNull android.hardware.Camera camera,
                                          Object cb) {
